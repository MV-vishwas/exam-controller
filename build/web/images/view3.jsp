    ...
    %>
        ...
        <table style="border: 1px solid black ; border-collapse: collapse ;margin-top: 30px; height: 300px;">
            ...
            <%
                ...
                ps = con.prepareStatement("select roll_no,ro,col from students where semster=? and branch=? and room_no=? order by ro asc , col asc");
                ps.setString(1, sem);
                ps.setString(2, dpt);
                ...
                if (size != count) 
                {
                    out.println("<form action='view3.jsp' method='post'>");
